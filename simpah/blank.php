    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="administrador.html">
        <div class="sidebar-brand-icon ">
          <img src="images/simpah.png" width="50" height="50">
        </div>
        <div class="sidebar-brand-text mx-3">Simpah IS</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" id="import">Excel</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item"  id="" >Descriptivos</a>
            <a class="collapse-item" id="" >Proyectivos</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePresta" class="collapse" aria-labelledby="headingPresta" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" id="prestar">Ver subscripciones</a>
            <a class="collapse-item" id="devolver">Pagos</a>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Derechos reservados &copy; Sistema agricola</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
